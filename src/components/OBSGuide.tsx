// src/components/OBSGuide.tsx (Updated)
  ...
  const tips = [
    {
      ...
      title: "Privacy First",
      description:
        "Never show private keys, seed phrases, or wallet details on stream",
      type: "warning",
    },
    {
      icon: Monitor,
      ...
      description:
        "Use one monitor for streaming, another for private trading activities",
      type: "info",
    },
    {
      icon: Settings,
      ...
      description:
        "Test your setup thoroughly before going live with real money",
      type: "success",
    },
  ];
    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-stream-card/10">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <Badge className="mb-4 border-primary/20 text-primary">
            Technical Setup
          </Badge>
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Professional streaming setup for pump.fun. Learn to stream safely
            while protecting your private information.
          </p>
        </div>
        ...
        <div className="relative mb-16 rounded-2xl overflow-hidden">
          ...
          <div className="absolute bottom-6 left-6">
            ...
            <h3 className="text-2xl font-bold text-white">
              Ready-to-Use OBS Configuration
            </h3>
          </div>
        </div>
            ...
            >
              <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <Badge className="text-xs">{step.time}</Badge>
                </div>
        ...
        <div className="text-center">
          ...
          >
            ...
            Get Personal Setup Help
            <ArrowRight className="ml-2 h-5 w-5" />
          </Button>
          <p className="text-sm text-muted-foreground mt-4">
            Join our live onboarding for complete OBS setup assistance
          </p>
        </div>
      </div>
