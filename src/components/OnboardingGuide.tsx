      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Everything you need to know to start pumping tokens safely and successfully. We'll guide you through every step live on stream.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {steps.map((step, index) => (
            <Card key={index} className="group hover:glow-border transition-all duration-300 bg-stream-card/50 backdrop-blur-sm border-border/50">
        ...
        <div className="bg-stream-card/30 rounded-2xl p-8 mb-8">
          <h3 className="text-2xl font-bold mb-6 text-center">Essential Tips</h3>
          <div className="grid md:grid-cols-3 gap-4">
            {tips.map((tip, index) => (
              <div key={index} className="flex items-start gap-3 p-4 bg-stream-card/50 rounded-lg">
